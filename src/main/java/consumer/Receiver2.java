...
public class Receiver2 {
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        String queueName = channel.queueDeclare().getQueue(); //deklarasi queue scr random namanya
        channel.queueBind(queueName, EXCHANGE_NAME, "sabuga.keren");

        //channel.queueDeclare(QUEUE_NAME, false, false, false, null);
        System.out.println(" [*] sabuga keren. Waiting for messages. To exit press CTRL+C");
